...
INSERT INTO Teams VALUES (NULL, 'ФМШ и Перваки', 0, '0000000000');

INSERT INTO TasksWeb VALUES (NULL, 'Infinity Timer', 'hard', 'description
Формат флага limeCTF{word_word_word}', '/TasksWeb/1', 'limeCTF{tim3_1s_r3lativ3}');

INSERT INTO TasksPPC VALUES (NULL, 'Lime Clicker', 'hard', 'description
Формат флага limeCTF{word_word_word_word}', '/TasksPPC/1', 'CTF{you_clicked_fast_enough}');
...
Формат флага limeCTF{word_word_word}', '/TasksReverse/1', 'limeCTF{vm_puzzle_mach1n3}');
...
Формат флага limeCTF{0000}', '/TasksCrypto/1', 'limeCTF{2485}');
